                                        ...
                                        var oGetExt = Reb.substring(Last,Reb.Length);
                                                  switch (oGetExt)
                                                            ...
                                                            case ".tga":
                                                                ...
                                                                break;
                                                            case ".tiff":    
                                                                    var extension = String_Time+ ".tiff";
                                                                break;
                                                            case ".jpg":    
                                                                    var extension = String_Time+ ".jpg";
                                                                break;
                                                            case ".bmp":    
                                                                    var extension = String_Time+ ".bmp";
                                                                break;
                                                            case ".avi":    
                                                                    var extension = String_Time+ ".avi";
                                                                break;
                                                            case ".mov":    
                                                                    var extension = String_Time+ ".mov";
                                                                break;
                                                            case ".png":    
                                                                    var extension = String_Time+ ".png";
                                                                break;
                                                            case ".psd":    
                                                                    var extension = String_Time+ ".psd";
                                                                break;
                                                            case ".exr":    
                                                                    var extension = String_Time+ ".exr";
                                                                break;
                                                            case ".gif":    
                                                                    var extension = String_Time+ ".gif";
                                                                break;
                                                            case ".dds":    
                                                                    var extension = String_Time+ ".dds";
                                                                break;
                                                           }
